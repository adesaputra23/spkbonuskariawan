                          ...
                          <?php echo $this->session->flashdata('message'); ?>
                            <div class="row">
                                ...
                                <?php if ($this->session->userdata('id_level') == 1) { ?>
                                  <button type="button" class="btn btn-default">Pilih Tahun</button>
                                    ...
                                    <ul class="dropdown-menu">
                                     ...
                                     <a href="<?=base_url('Penilaian/hitung')?>" class="btn btn-primary"><i class="fa fa-calculator" aria-hidden="true"></i> Lihat Perhitungan</a>
                                     <a href="<?=base_url('Penilaian/penilaian_pdf')?>" class="btn btn-warning" target="_BLANK"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                                ...
                                <?php }elseif($this->session->userdata('id_level') == 3) { ?>
                                    <a href="<?=base_url('Penilaian/hitung')?>" class="btn btn-primary"><i class="fa fa-calculator" aria-hidden="true"></i> Lihat Perhitungan</a>
                                     <a href="<?=base_url('Penilaian/penilaian_pdf')?>" class="btn btn-warning"><i class="fa fa-file-pdf-o" aria-hidden="true" target="_BLANK"></i> PDF</a>
                                <?php } ?>
                               </div>
                                <div class="col-sm-4">
