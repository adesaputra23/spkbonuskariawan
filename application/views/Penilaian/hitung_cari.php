                          ...
                          <?php echo $this->session->flashdata('message'); ?>
                            <div class="row">
                                <div class="col-lg-12 text-right">
                                    ...
                                    <a href="<?= base_url('Dashboard/data_nilai_kariawan/')?>?nik=<?=$this->session->userdata('nik');?>"><span class="label label-default"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</span></a>
                                    <?php } ?>
                                    
                                </div>
                                <a href="<?= base_url('Penilaian/hitung_cari_pdf/').$nik?>" class="btn btn-warning" target="_BLANK"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                            <br>
                            <br>
                            </div>
                            <br>
