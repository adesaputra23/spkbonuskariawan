<div class="container">
        ...
        <h1>Perhitungan <small>Gap | Bobot | Core Factor | Secondary Factor | Total</small>
        <p><small>Data Perhitungan NIK : <?=$nik?></small> |
        <small>Nama Karyawan : <?=$dsc[0]->nama_kariawan?><small></p></h1>
