                ...
                <div class="row">
                                <div class="col-sm-8 btn-group">
                                 <button type="button" class="btn btn-default">Pilih Tahun</button>
                                    ...
                                    <a href="<?=base_url('Dashboard/grafik_pdf/')?>?tahun=<?=$tahun?>" class="btn btn-warning" target="_BLANK"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF</a>
                                </div>
                </div>
                </div>
            ...
            <br>
                ...
                <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <canvas id="speedChart" width="100" height="35"></canvas>
                        </div>
                    </div>
        </div>
    </div>
